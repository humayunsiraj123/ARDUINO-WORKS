...
if (Serial2.available()>0)
  ...
  if(Serial2.available()){
    Serial.println("DAY SERIAL AVAILABEL 22222 ");
  tft_days[6]=highByte(nox);
  tft_days[7]=lowByte(nox);
   Serial2.write(tft_days,8);
  }
   delay(10);
   motor_value++;
  if(Serial2.available()){
    Serial.println("PUMP SERIAL AVAILABEL 22222");
  tft_pump[7] = motor_value%2;
  Serial2.write(tft_pump,8);
    delay(10);
  Serial2.write(tft_backup,8);
    delay(10);
