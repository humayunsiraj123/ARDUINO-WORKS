...
//    writeFile(LittleFS, "/data_logger.txt","LOGGING RANDOM DATA");
//    Serial.println( "Test complete" ); 

    
}
unsigned long int prev_t1 =0;
unsigned long int prev_t2 =0;;
int rand_no; 


void loop(){

 if(millis()-prev_t2 > 2000)
 {prev_t2=millis();
  Serial.println("*****************************************************");
  readFile(LittleFS, "/data_logger.txt");
  }

//if(millis()-prev_t1 > 100)
// {prev_t1=millis();
//  rand_no = random(0,1000);
//  appendFile(LittleFS, "/data_logger.txt", (String(++rand_no)+ "\r\n").c_str()); //Append some text to the previous fil
//  }
