        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /26/on") >= 0) {
              Serial.println("Door opening on");
              output26State = "on";
              digitalWrite(output26, LOW);
            } else if (header.indexOf("GET /26/off") >= 0) {
              Serial.println("Door opening off");
              output26State = "off";
              digitalWrite(output26, HIGH);
            } else if (header.indexOf("GET /27/on") >= 0) {
              Serial.println("Door closing on");
              output27State = "on";
              digitalWrite(output27, LOW);
            } else if (header.indexOf("GET /27/off") >= 0) {
              Serial.println("Door closing off");
              output27State = "off";
            ...
            // Web Page Heading
            client.println("<body><h1>Mankaran's Garage</h1>");
             client.println("<h3> TEMPERATURE  " + String(temperature) + String("'C")+ "</h3>");
             client.println("<h3> HUMIDITY     " + String(humidity) + String("%")+ "</h3>");
             
            // Display current state, and ON/OFF buttons for GPIO 26  
            client.println("<p>Door opening - State " + output26State + "</p>");
