...
#define soil_sensor_2 36   // Pin connected to soil moisture sensor
#define pump_1 4     // Pin connected to relay control
#define pump_2 5     // Pin connected to relay control
...
void soilMoistureSensor() {
  ...
  int soilMoisture_1 =a; //analogRead(soil_sensor_1);//analogRead(soil_sensor_2);
